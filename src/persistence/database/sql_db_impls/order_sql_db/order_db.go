...
func (odb *OrderDb) GetOrder(id string) (*models.Order, error) {
	stmt, err := odb.dbDriver.Prepare(`
	select o.id, o.comment, o.status, o.accepted,
	ifnull(d.name, '') as 'name', ifnull(d.surname, '') as 'surname',
	b.price as "total",
	a.name as "article_name", a.description as "article_description" , a.price as "article_price",
	ab.article_quantity as "article_quantity",
...
func (odb *OrderDb) GetOrdersByDelivererId(delivererID string) ([]models.Order, error) {
	stmt, err := odb.dbDriver.Prepare(`select o.id, o.comment, o.status, o.accepted,
	ifnull(d.name, '') as 'name', ifnull(d.surname, '') as 'surname',
	b.price as "total",
	a.name as "article_name", a.description as "article_description" , a.price as "article_price",
	...
	rows, err = stmt.Query(delivererID)
